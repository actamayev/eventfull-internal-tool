...
const usersDashboardColumns: ColDef[] = [
	...
	{ headerName: "Phone Number", field: "phoneNumber", comparator: caseInsensitiveComparator, width: 170 },
	{ headerName: "Friend Count", field: "numberOfFriends", width: 150 },
	{ headerName: "Last Login", field: "lastLogin", comparator: dateComparator, width: 151 },
	{ headerName: "Account Created", field: "createdAt", comparator: dateComparator, width: 151 },
]
